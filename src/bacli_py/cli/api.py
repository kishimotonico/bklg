"""Direct API access commands for bacli."""
...
def api_call(
    ...
    Examples:
        ...
        bacli api /issues --method POST --data "projectId=1" --data "summary=test"
        bacli api /issues --method POST --json '{"projectId":1,"summary":"test"}'
